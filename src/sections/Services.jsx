            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {services.map((service, index) => (
                    ...
                    >
                        ...
                        <div className="w-14 h-14 bg-black/50 rounded-xl flex items-center justify-center mb-6 border border-white/10 group-hover:border-neonBlue/50 transition-colors">
                            <service.icon className="w-7 h-7 text-white group-hover:text-neonBlue transition-colors" />
                        </div>

                        <h3 className="text-xl font-bold mb-3 group-hover:text-neonBlue transition-colors">{service.title}</h3>
